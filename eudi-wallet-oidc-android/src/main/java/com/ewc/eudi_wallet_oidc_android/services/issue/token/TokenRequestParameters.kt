    ...
    companion object {
        ...
        fun build(
            ...
            val clientId = ClientIdentity.resolve(
                isPreAuthorisedCodeFlow = grant is TokenGrant.PreAuthorized,
                ...
                clientId = WalletUnitAttestationHeaders.clientId(attestation?.attestationJwt, wallet.did),
            )
            ...
            return when (grant) {
                is TokenGrant.PreAuthorized -> TokenRequestParameters(
                    ...
                    code = grant.code,
                    // Section 6.1 makes client authentication OPTIONAL here; ClientIdentity above
                    // decides whether one goes out, so this is no longer unconditionally absent.
                    clientId = clientId,
                    txCode = grant.txCode,
                    txCodeParameterName =
